      ...
      <div className={this.props.isToggleOn ? "nav-on":"nav"}>
        ...
        <div className="nav-wrapper">
          ...
          <div className="nav-header">Categories</div>
            ...
            <a href= "https://medium.com/@hanselwong/?ref=neede.co"  target="_blank" rel="noopener noreferrer" className="nav-button" activeStyle={{fontFamily: "Montserrat-Medium",color: '#5156E5',fill: '#5156E5'}} onClick={() => this.props.componentDidMount()}><IconComponent icon="copy"/><div className="spacer"/>Articles</a>
