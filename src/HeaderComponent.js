...
class HeaderComponent extends Component{
  ...
  render(){
    return(
      ...
      <p className={this.props.filterCategory === "About" ? "header":"header-hidden"}>About</p>
      <p className={this.props.filterCategory === "About" ? "description":"description-hidden"}>Description about Neede.</p>
