...
class About extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="about-description"><br/>Neede was founded and curated by <a href="https://twitter.com/yourshansel" target="_blank" className="about-link">Hansel Wong</a></div>
