...
class About extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="about-description">Send me any links or categories you’d like to see added to Neede at <a href="mailto:neede.design@gmail.com" className="about-link">neede.design@gmail.com</a>.</div>
      <div className="about-header">Subscribe to our mailing list to receive updates!</div>
      <EmailForm/>
