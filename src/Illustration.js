...
class Illustration extends Component {
  ...
  render() {
    ...
    let cardComps = sortBy(mergedData, "name").filter(data => data.category === "Illustration").map((data, index) => {
      return (
    ...
    return (
      ...
      <div className="description">Vector illustrations, drawings and graphical elements.</div>
